...
public class Produit {
    ...
    public boolean comparer(Produit p) {
        return this.id == p.getId() && this.libellee.equals(p.getLibellee()) && this.prix == p.getPrix();
    }

    public static boolean comparer2Prod(Produit p1, Produit p2) {
        return p1.getId() == p2.getId()
                && p1.getLibellee().equals(p2.getLibellee())
